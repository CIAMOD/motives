...
def solve_exact_sequence(
    ...
    sequence is converted into equations by ``exact_sequence_relations`` and all
    ...
    for sequence in normalized_sequences:
        sequence_equations = exact_sequence_relations(sequence=sequence, invariant=invariant, component=component)
